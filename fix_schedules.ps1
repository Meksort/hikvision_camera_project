# Скрипт для копирования и запуска check_and_fix_schedules.py в Docker контейнере

Write-Host "=" * 80 -ForegroundColor Cyan
Write-Host "ИСПРАВЛЕНИЕ ГРАФИКОВ РАБОТЫ СОТРУДНИКОВ" -ForegroundColor Cyan
Write-Host "=" * 80 -ForegroundColor Cyan
Write-Host ""
...
# Запускаем скрипт
Write-Host "Запуск скрипта исправления..." -ForegroundColor Cyan
Write-Host ""
