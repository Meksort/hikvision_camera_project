            ...
            if emp_schedule and current_date:
                ...
                if scheduled_times:
                    ...
                    if clean_emp_id:
                        ...
                        # НОВАЯ ФОРМУЛА: Для круглосуточных графиков используем значение из SQL (сумма всех фактических периодов)
                        if schedule_type == 'round_the_clock':
                            # Для круглосуточных графиков используем значение из SQL запроса
                            # SQL уже суммирует все индивидуальные периоды работы (вход-выход) за день
                            # Не пересчитываем, используем значение из SQL
                            pass  # total_duration_seconds уже установлен из SQL как сумма всех периодов
